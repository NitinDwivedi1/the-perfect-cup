            ...
            $('#login').on('click',function(){
                ...
                $.ajax({
                    ...
                    success:function(html){
                        if(html=='true'){
                            $('#msg').html('<div class="alert alert-success"><strong>Authenticated!</strong></div>');
                            window.location.href="blog.php";
                        }
                        else if(html=='false'){
                            $('#msg').html('<div class="alert alert-danger">Error: <strong>Authentication</strong> failure!</div>');
                        }
                    }
