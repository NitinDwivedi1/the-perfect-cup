...
<head>
    ...
    <meta name="description" content="professional web designing">
    <meta name="author" content="Nitin Dwivedi">
...
<body>
    ...
    <?php
        if(isset($_GET['logout']))
        {
            if($_GET['logout']=="true")
            { ?>
                <div class="alert alert-success"><strong>You have been logged out of the system.</strong></div>;
                <?php
            }
        }
    ?>
